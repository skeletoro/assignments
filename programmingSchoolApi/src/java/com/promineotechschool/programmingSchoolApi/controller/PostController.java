package com.promineotechschool.programmingSchoolApi.controller;
...
import com.promineotechschool.programmingSchoolApi.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<Objedct> createPost(@RequestBody Post post, @PathVariable Long userId) {
		try {
